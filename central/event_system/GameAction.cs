    ...
    //    Debug.Log("Doing gameaction " + this._type + " " + this.name + " " + _text + "\n");
        switch (_type)
        {
            case ActionType.UIFilter:
                if (_name.Equals("")) EagleEyes.Instance.ResetUIFilter();
                else EagleEyes.Instance.SetUIFilter(_name, _text);
                break;
            ...
            case ActionType.Panel:
                ...
                if (panel == null) { Debug.LogError("GameAction could not find object " + _name + "\n"); }
                if (!_bool)
                {
            ...
            case ActionType.EnemyDescription:
                ...
                if (enemy_desc == null) { Debug.LogError("GameAction could not find object " + _name + "\n"); }                
         ...
         //       Debug.Log("Resuming\n");
            ...
            case ActionType.PointSpyGlass:
                if (Monitor.Instance != null) Monitor.Instance.my_spyglass.PointSpyglass(_vector, true);
                break;
