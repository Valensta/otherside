...
public static class LevelStore
{
    ...
    public static void initSettings()
    {
        ...
        new List<LevelMod> //2
        {
            new LevelMod(Difficulty.Normal,0.15f,-0.5f,0,false,1.15f,1.15f),
        ...
        new List<LevelMod>  //6
        {
         ...
         new List<LevelMod>  //7
        {
            new LevelMod(Difficulty.Normal,0.25f,0.25f,-0.5f,false, 1.3f,1.3f),
            new LevelMod(Difficulty.Hard,0.1f,0f,0f,false, 1.1f, 1.1f),
            new LevelMod(Difficulty.Insane,0f,0f,0f,false, 1f,1f)
        },
            new List<LevelMod>  //8
            {
                new LevelMod(Difficulty.Normal,1.2f,0,-0.5f,false, 1,1),
                new LevelMod(Difficulty.Hard,0f,-0.2f,0f,false, 0.85f, 0.85f),
