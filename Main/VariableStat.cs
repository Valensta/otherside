...
public class Temporary
{
    ...
    public Temporary(List_Panel panel, WishType type, float _percent, float _time, string label_name, bool has_label)
    {
        percent = _percent;
    ...
    public void getLabel(List_Panel panel)
    {
    ...
    public void RemoveLabel(List_Panel my_panel)
    {        
